...
# MD5 (RFC 1321). Round table K/S below are the standard published
# constants for the algorithm, adapted from the public-domain-style
# reference at github.com/bahamas10/bash-md5.
_MD5_S=(
